...
class FeedbackController extends Controller
{
	...
	public function index()
	{
		...
		->select('ratings.id as id ', 'users.name as user_name', 'products.name as product_name', 'rate', 'comment', 'ratings.created_at as created at', 'ratings.updated_at as updated_at' )
