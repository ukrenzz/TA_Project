...
<a class="breadcrumb-item" href="{{ route('category.manage') }}">Category</a>
  ...
  <div class="card-body">
    ...
    <form id="form-validation" action="{{$mode == 'edit' ? route('category.update') : route('category.store')}}" method="post">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label control-label">Category Name<span class="text-danger">*</span></label>
        <div class="col-sm-10">
      ...
      <div class="form-group text-right">
        <button class="btn btn-primary">{!! $mode == "edit" ? '<i class="anticon anticon-form"></i> Edit' : '<i class="anticon anticon-plus"></i> Add' !!}</button>
      </div>
    </form>
  </div>
</div>
