  ...
  <div class="container">
    ...
    <div class="col-lg-6">
        ...
        <div class="collapse dont-collapse-sm contacts" id="collapse_3">
          <ul >
            <li style="display: inline; margin-right: 10px"><i class="ti-home"></i>Medan, Indonesia</li>
            <li style="display: inline;  margin-right: 10px"><i class="ti-headphone-alt"></i>+62 2102912 12812</li>
            <li style="display: inline;  margin-right: 10px"><i class="ti-email"></i><a href="#0">info@neko.com</a></li>
          </ul>
        </div>
      </div>
    <div class="col-lg-6">
